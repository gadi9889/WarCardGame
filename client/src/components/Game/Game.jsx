...
export default function Game({playerCards, opponentCards,restartFunc}) {
    const [playerCard, setPlayerCard] = useState(playerCards[playerCards.length-1])
    const [opponentCard, setOpponentCard] = useState(opponentCards[opponentCards.length-1])
    ...
    return (
        <div id="card-plane">
            ...
            <div>
                <Button id='hit-button' style={{width:'3vw',height:'4vh'}} onClick={() =>hitHandle()}>Hit</Button>
            </div>
