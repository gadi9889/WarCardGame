...
function C6() {
  return (
    ...
    >
      ...
      <symbol id="a">
        <path d="M2 0h4l2 2v2H6V2H2v3h4l2 2v3l-2 2H2l-2-2V2zm0 7v3h4V7z"></path>
      </symbol>
      <symbol id="c">
      ...
      <use transform="matrix(1.5 0 0 1.5 16 36.5)" xlinkHref="#b"></use>
      <use transform="matrix(1.5 0 0 1.5 29 36.5)" xlinkHref="#b"></use>
